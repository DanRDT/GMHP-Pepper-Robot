...
var questions = [
  [
    "How happy have you felt at school so far this year? (1 being not much, 10 meaning that it's the best year so far)",
    questionTypes[2],
  ],
  ['Which subject do you like the most?', questionTypes[1], ['Maths', 'English', 'Art', 'Science']],
  ['What is the main reason for liking this subject?', questionTypes[0]],
  ["What's the best part of the day at school?", questionTypes[0]],
  [
    'How much do you enjoy the school lunch? (1 being not much, 10 meaning that you love the school lunch!) ',
    questionTypes[2],
  ],
  ['Which subject do you find less fun?', questionTypes[1], ['Maths', 'English', 'Art', 'Science']],
  ...
  [
    'Did you enjoy interacting with me today?',
    questionTypes[1],
...
$(document).ready(function () {
  ...
  $('#submitAnswer').mousedown(function (e) {
  ...
  $('#submitAnswer').click(function () {
    ...
    answers +=
      '<li>Question ' + questionNumber + ": '" + questions[questionNumber - 1][0] + ",  Answer - '" + answer + "'</li>"
    questionNumber++
...
function finish() {
  ...
  Email.send({
    ...
    Body:
      ...
      studentResults +
      `</html>`,
  }).then(performSpeech('Results have been sent to email.'))
}
